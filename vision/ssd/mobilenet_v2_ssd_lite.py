...
from ..nn.modified_mobilenet_v2 import CustomNet, ModifiedResidual
...
def create_custom_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False):
    base_net = CustomNet(width_mult=width_mult, use_batch_norm=use_batch_norm,
                         onnx_compatible=onnx_compatible).features
    ...
    extras = ModuleList([
        ...
        ModifiedResidual(256, 256, stride=2, expand_ratio=0.5),
        ModifiedResidual(256, 64, stride=2, expand_ratio=0.25)
    ])
